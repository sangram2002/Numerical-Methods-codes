...
for (int k = 0; k < 10; k++)
{
    ...
    cout << "" << endl;
        ...
        cout << "The value of sin(" << Value << ") "<<"with "<< n <<" Chebyshev points calculated by interpolation = " << setprecision(15)<< sum << endl;
...
??? There is not much improvement for sin(x) using Chebushev points
    return 0;
}
