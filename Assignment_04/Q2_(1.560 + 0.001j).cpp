...
int main()
{
    ...
    cout << " Newton's Forward Difference Table Using values of sin x for x = 1.560 + 0.001j, (j = 1,2,...,10):" << endl;
    ...
    cout<<""<<endl;
    //? these values are totally outside the range of table in degree.
    double y_value[4] = {0.999995, 0.99995, 0.9999, 0.9995};
    //? What have you done? You should just interchange x and Y[][0] and
    ///? repeat the process
